/**
 * Sample pulled from https://developers.perfectomobile.com/display/PD/Protractor+code+sample
 * 
 * Not working beyond the first lines of "Test 1"
 * Used to verify local environment could run prtoractor tests
 * Also used to show selenium web driver wrapper usage with protractor
 */
